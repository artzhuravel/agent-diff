...
ID_FORMATS: dict[str, dict] = {
    # "resource_name": {"alphabet": ALPHANUMERIC, "length": 16},
    "project": {"alphabet": NUMERIC, "length": 16},
    "section": {"alphabet": NUMERIC, "length": 16},
    "user": {"alphabet": NUMERIC, "length": 16},
    "story": {"alphabet": NUMERIC, "length": 16},
    "task": {"alphabet": NUMERIC, "length": 16},
    "tag": {"alphabet": NUMERIC, "length": 16},
}
