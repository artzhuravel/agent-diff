...
- **Fields referencing projects**: `data.attributable_to`, `data.custom_field_settings.parent`, `data.memberships.project`, `data.new_project`, `data.new_task`, `data.parent`, `data.project`, `data.projects`
...
Evidence:
  ...
  - GET /projects/{project_gid}/custom_field_settings — property: data.parent (incoming)
  - GET /projects/{project_gid}/project_memberships — property: data.parent (incoming)
  - POST /projects — property: data.custom_field_settings.parent (incoming)
  - POST /projects — property: data.custom_field_settings.parent (incoming)
  - PUT /projects/{project_gid} — property: data.custom_field_settings.parent (incoming)
  - PUT /projects/{project_gid} — property: data.custom_field_settings.parent (incoming)
  - GET /projects/{project_gid} — property: data.custom_field_settings.parent (incoming)
  ...
  - POST /teams/{team_gid}/projects — property: data.custom_field_settings.parent (incoming)
  - POST /teams/{team_gid}/projects — property: data.custom_field_settings.parent (incoming)
  - POST /workspaces/{workspace_gid}/projects — property: data.custom_field_settings.parent (incoming)
  - POST /workspaces/{workspace_gid}/projects — property: data.custom_field_settings.parent (incoming)
  - POST /projects/{project_gid}/addCustomFieldSetting — property: data.parent (incoming)
  - POST /projects/{project_gid}/addMembers — property: data.custom_field_settings.parent (incoming)
  - POST /projects/{project_gid}/removeMembers — property: data.custom_field_settings.parent (incoming)
  - POST /projects/{project_gid}/addFollowers — property: data.custom_field_settings.parent (incoming)
  - POST /projects/{project_gid}/removeFollowers — property: data.custom_field_settings.parent (incoming)
...
Evidence:
  ...
  - POST /tasks — property: data.dependencies
  - POST /tasks — property: data.dependents
  ...
  - PUT /tasks/{task_gid} — property: data.dependencies
  - PUT /tasks/{task_gid} — property: data.dependents
  ...
  - GET /tasks/{task_gid} — property: data.dependencies
  - GET /tasks/{task_gid} — property: data.dependents
  ...
  - POST /tasks/{task_gid}/subtasks — property: data.dependencies
  - POST /tasks/{task_gid}/subtasks — property: data.dependents
  ...
  - POST /tasks/{task_gid}/setParent — property: data.dependencies
  - POST /tasks/{task_gid}/setParent — property: data.dependents
  - POST /tasks/{task_gid}/setParent — property: data.parent
  - GET /tasks/{task_gid}/dependencies — url_segment: tasks
  - GET /tasks/{task_gid}/dependencies — url_segment: task_gid
  - GET /tasks/{task_gid}/dependencies — url_segment: dependencies
  ...
  - POST /tasks/{task_gid}/addDependents — property: data.dependents
  - POST /tasks/{task_gid}/removeDependents — url_segment: tasks
  - POST /tasks/{task_gid}/removeDependents — url_segment: task_gid
  - POST /tasks/{task_gid}/removeDependents — property: data.dependents
  ...
  - POST /tasks/{task_gid}/addFollowers — property: data.dependencies
  - POST /tasks/{task_gid}/addFollowers — property: data.dependents
  ...
  - POST /tasks/{task_gid}/removeFollowers — property: data.dependencies
  - POST /tasks/{task_gid}/removeFollowers — property: data.dependents
  ...
  - GET /workspaces/{workspace_gid}/tasks/custom_id/{custom_id} — property: data.dependencies
  - GET /workspaces/{workspace_gid}/tasks/custom_id/{custom_id} — property: data.dependents
...
- Primary key: `gid`
- Direction: incoming
- **Fields referencing teams**: `data.custom_field_settings.parent`, `data.parent`
...
- Primary key: `gid`
- Direction: outgoing
- **Fields referencing users**: `data.assigned_by`, `data.assignee`, `data.completed_by`, `data.created_by`, `data.custom_fields.created_by`, `data.custom_fields.people_value`, `data.followers`, `data.hearts.user`, `data.new_task.created_by`, `data.task.created_by`
...
- Primary key: `gid`
- Direction: outgoing, incoming
- **Fields referencing workspaces**: `data.parent`, `data.workspace`
...
Evidence:
  ...
  - GET /workspaces/{workspace_gid}/events — property: data.parent (incoming)
