# Endpoint Verification: Asana — tags (batch 2/2)
...
Request body (application/json): inline: {"type":"object","properties":{"data":{"$ref":"#/schemas/TagCreateTagForWorkspaceRequest"}}}
Responses:
...
```
automatic_schema_generation/apps/asana/pipeline_out/test_results/tags_batch2.json
```
