# Entity Implementation: user

You are implementing the **user** resource for the Todoist API
replica. You will add code to four existing files. Do not create new files.

## Context provided

### OpenAPI excerpt for user
...
Resource `user` uses: alphabet=NUMERIC, length=10
